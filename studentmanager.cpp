	...
	protected:
		...
		public:
			void input_details()
			{
				...
				cin>>sub2;
				cout<<"\n";
				cout<<"\n\nEnter the Mark of Digital Electronics ==>";
				cin>>sub3;
				cout<<"\n";
				cout<<"\n\nEnter the Mark of Data Structure ==>";
				cin>>sub4;
				cout<<"\n";
				cout<<"\n\nEnter the Mark of PPL ==>";
				cin>>sub5;
				cout<<"\n";
			...
			void output_details()
			{
				cout<<"\tMaulana Azad National Institute of Technology"<<endl;
			...
			void output_marksheet()
			{
				...
				cout<<"Marks of Digital Electronics			 100                          "<<sub3<<endl;
				cout<<"Marks of Data Structure			 100                          "<<sub4<<endl;
				cout<<"Marks of PPL 		    	 	 100                          "<<sub5<<endl;
				cout<<"Marks of Python	 		 100                          "<<sub6<<endl;
...
class master : virtual public student
{
	public:
		...
		void update()
		{
			...
			cout<<"\n\n Digital Electronics Marks ===>"<<sub3<<"\n";
			cout<<"\n\n Data Structure Marks ===>"<<sub4<<"\n";
			cout<<"\n\n PPL Marks ===>"<<sub5<<"\n";
			cout<<"\n\n Python Marks ===>"<<sub4<<"\n";
			cout<<"\n\n Enter Your Choice ====>";
			cin>>choice;
